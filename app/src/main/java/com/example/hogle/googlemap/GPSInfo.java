...
public class GPSInfo extends Service implements LocationListener {
    ...
    private static final long MIN_TIME_BW_UPDATES = 1000 * 30 * 1; //1000 * 60 * 1;

    protected LocationManager locationManager;

    public GPSInfo(MapsActivity context) {
    ...
    public void onLocationChanged(Location location) {
        ...
        if (location != null) {
            ...
            mContext.currentLat = location.getLatitude();
            mContext.currentLng = location.getLongitude();

            mContext.locationDistance();
